 ...
 *  of the show.
 */
exports.blockBufferGenerator = (duration, commercialList, promoList, fillerShowList, defaultPromo) => {
...
exports.streamBufferGenerator = (duration, commercialList, promoList, fillerShowList, fillerMovieList) => {
    ...
    //Find the highest duration to allow a duration at the end of the buffer to ensure the final clip
    //selected is never longer than the remainder of the buffer
    let highestClipDuration = getHighestClipDuration(duration, commercialList, promoList);

    let bufferBlock = loadBufferBlock(duration, highestClipDuration / 2, commercialList, promoList);
    selectedCommercials = bufferBlock.commercials;
    selectedPromos.push(...bufferBlock.promos);
    currentDuration = currentDuration + bufferBlock.duration
