...
exports.bufferGenerator = (duration, commercialList, promoList, fillerShowList) => {
    ...
    */
    if (promoList.some(item => item.duration <= duration)) {
        ...
        //Find the highest duration to allow a buffer at the end of the buffer, to ensure there is space to 
        //select a final clip from any duration available.
