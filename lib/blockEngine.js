            ...
            if (!skipShow) {
                ...
                if (selectedShow !== undefined) {
                    ...
                    if (sortedBlockShows
                        ...
                        let selectedClips = bufferEng.bufferGenerator(sortedShow.DurationLimit - currentShowBlockDuration, blockCommercials, blockPromos, fillerShows, blockPaths.DefaultPromo);
                        // selectedClips.selectedCommercials.forEach(item => createdBlock.Items.push(item.path));
