...
const getShow = (
    ...
    if (currentDuration > 1800) {
        ...
        if (options.progression === undefined) {
            currentEpisode = Math.floor(Math.random() * (show.EpisodeCount - 1))
        }
...
const selectMedia = (media,
    ...
    while (mediaDuration > currentDuration) {
        ...
        //Flip the coin, heads is a movie, tails is a show
...
exports.createProceduralBlock = (options,
    ...
    selectedMovies.push(...tagComboMedia.Movies);
    selectedMovies.push(...tagMedia.Movies);
    selectedShows.push(...tagComboMedia.Shows);
    selectedShows.push(...tagMedia.Shows);
    items.push(...tagComboMedia.Movies);
    items.push(...tagMedia.Movies);
    items.push(...tagComboMedia.Shows);
