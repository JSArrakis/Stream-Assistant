...
describe('tagTranslator', () => {
    ...
    it('should return a TranslatedTags object when tags are provided (scenario 1)', () => {
        const tags: string[] = ['scifi', 'animated', 'adventure', 'cgi', 'kids', '1990s'];
        const expectedSegmentedTags: SegmentedTags = new SegmentedTags(['1990s'], ['scifi', 'adventure'], ['animated', 'cgi'], ['kids'], []);
