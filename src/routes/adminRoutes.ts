...
router.get('/get-all-show-data', verify.getShowValidationRules, showCont.getAllShowsDataHandler);

// Movie Management
router.post('/create-movie', verify.createMovieValidationRules, movCont.createMovieHandler);
router.post('/bulk-create-movies', verify.bulkCreateMoviesValidationRules, movCont.bulkCreateMovieHandler);
...
router.post('/bulk-create-commercials', verify.bulkCreateBufferValidationRules, commCont.bulkCreateCommercialHandler);
...
router.post('/bulk-create-shorts', verify.bulkCreateBufferValidationRules, shortCont.bulkCreateShortHandler);
...
// Music Management
router.post('/create-music', verify.createBufferValidationRules, musicCont.createMusicHandler);
router.post('/bulk-create-music', verify.bulkCreateBufferValidationRules, musicCont.bulkCreateMusicHandler);
router.delete('/delete-music', verify.deleteBufferValidationRules, musicCont.deleteMusicHandler);
router.put('/update-music', verify.updateBufferValidationRules, musicCont.updateMusicHandler);
router.get('/get-music', verify.getBufferValidationRules, musicCont.getMusicHandler);
router.get('/get-all-music', verify.getBufferValidationRules, musicCont.getAllMusicHandler);

// Promo Management
router.post('/create-promo', verify.createBufferValidationRules, promoCont.createPromoHandler);
router.post('/bulk-create-promos', verify.bulkCreateBufferValidationRules, promoCont.bulkCreatePromoHandler);
router.delete('/delete-promo', verify.deleteBufferValidationRules, promoCont.deletePromoHandler);
router.put('/update-promo', verify.updateBufferValidationRules, promoCont.updatePromoHandler);
router.get('/get-promo', verify.getBufferValidationRules, promoCont.getPromoHandler);
router.get('/get-all-promos', verify.getBufferValidationRules, promoCont.getAllPromosHandler);
