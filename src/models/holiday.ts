...
export class Holiday {
    ...
    constructor(name: string, seasonStartDate: Date, seasonEndDate: Date, holidayDate: Date) {
        this.Name = name;
...
export const HolidayModel: Model<IHoliday> = mongoose.model<IHoliday>('Holiday', HolidaySchema);